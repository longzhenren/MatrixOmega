...
public class TypeChange {
    ...
    public static String MtoS(Matrix m) {
        ...
        for (int i = 0; i < row; i++) {
            for (int j = 0; j < column; j++) {
                switch (lenth) {
                    case 1:
                        Matrix.append(String.format("%.1f", a[i][j])).append(" ");
                        break;
                    case 2:
                        Matrix.append(String.format("%.2f", a[i][j])).append(" ");
                        break;
                    case 3:
                        Matrix.append(String.format("%.3f", a[i][j])).append(" ");
                        break;
                    case 4:
                        Matrix.append(String.format("%.4f", a[i][j])).append(" ");
                        break;
                    case 5:
                        Matrix.append(String.format("%.5f", a[i][j])).append(" ");
                        break;
                    case 0:
                        Matrix.append(String.format("%.0f", a[i][j])).append(" ");
                        break;
                }
            }
            Matrix.append("\n");
    ...
    public static String getdiagonal(Matrix m) {
        ...
        for (int i = 0; i < count; i++) {
            switch (lenth) {
                case 1:
                    temp.append("特征值").append(i + 1).append(":").
