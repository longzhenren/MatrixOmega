...
public class OtherCalculate extends JPanel implements ActionListener{
	private static OtherCalculate OCalculate = new OtherCalculate();
    JPanel jpanel;  
    ...
    public void actionPerformed(ActionEvent e) {  
        ...
        {  
        	...
        	dresult = Calculate.CalculateCond(jta.getText());
        ...
        {  
        	...
        	dresult = Calculate.CalculateDet(jta.getText());
        ...
        {  
        	...
        	dresult = Calculate.CalculateRank(jta.getText());
        ...
        else if (e.getSource() == jb4)
        {
        	...
        	result = Calculate.CalculateInv(jta.getText());
        	if (result == null)
        	{
