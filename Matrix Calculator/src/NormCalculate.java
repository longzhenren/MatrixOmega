...
public class NormCalculate extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {  
        ...
        {  
        	...
        	result = Calculate.CalculateNormOne(jta.getText());
        ...
        {  
        	...
        	result = Calculate.CalculateNormTwo(jta.getText());
        ...
        {  
        	...
        	result = Calculate.CalculateNormF(jta.getText());
        ...
        {  
        	...
        	result = Calculate.CalculateNormInf(jta.getText());
