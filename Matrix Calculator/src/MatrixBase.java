...
//实现接口ActionListener  
public class MatrixBase extends JPanel implements ActionListener {
    private static MatrixBase BCalculate = new MatrixBase();
    JPanel jpanel;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jb1) {
            ...
            result = CalculateCore.CalculateAdd(jta.getText(), jtb.getText());
            if (result == null) {
            ...
            result = CalculateCore.CalculateSubtract(jta.getText(), jtb.getText());
            ...
            result = CalculateCore.CalculateMul(jta.getText(), jtb.getText());
            if (result == null) {
            ...
            result = CalculateCore.CalculateSolve(jta.getText(), jtb.getText());
            if (result == null) {
     ...
     * @return 返回此页面的实例
     */
    public static MatrixBase getBaseCalculate() {
        return BCalculate;
    }
    public static JButton getjb1() {return getBaseCalculate().jb1; }
    public static JButton getjb2() {return getBaseCalculate().jb2; }
    public static JButton getjb3() {return getBaseCalculate().jb3; }
    public static JButton getjb4() {return getBaseCalculate().jb4; }
